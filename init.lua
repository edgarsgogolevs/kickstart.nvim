...
MAX_COL = 120
vim.cmd('set colorcolumn=' .. MAX_COL)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[F]ind by [G]rep in ALL files' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    --   tsq.set("python", "injections", (tsq.get_files("python", "injections"))[1])return {}
    -- end
    --
    --
